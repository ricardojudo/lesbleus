...
RSpec.describe StopsController, :type => :controller do
  ...
  let(:valid_attributes) {
    ...
    FactoryGirl.attributes_for(:stop)
  }
  ...
  describe "GET index" do
    it "assigns all stops as @stops" do
      ...
      expect(assigns(:stops)).to eq([stop])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stop as @stop" do
        post :create, {:stop => invalid_attributes}, valid_session
        expect(assigns(:stop)).to be_a_new(Stop)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      let(:new_attributes) {
         FactoryGirl.attributes_for(:stop, :name => Faker::Name.name)
      }

      it "updates the requested stop" do
        stop = Stop.create! valid_attributes
        put :update, {:id => stop.to_param, :stop => new_attributes}, valid_session
        stop.reload
    ...
    describe "with invalid params" do
      it "assigns the stop as @stop" do
        stop = Stop.create! valid_attributes
        put :update, {:id => stop.to_param, :stop => invalid_attributes}, valid_session
        expect(assigns(:stop)).to eq(stop)
      end
